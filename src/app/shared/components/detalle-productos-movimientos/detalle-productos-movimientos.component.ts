...
@Component({
  selector: 'app-detalle-productos-movimientos',
  templateUrl: './detalle-productos-movimientos.component.html',
  styleUrls: ['./detalle-productos-movimientos.component.css']
})
export class DetalleProductosMovimientosComponent implements OnInit {
  @Input() datosproducto = [];
