...
export class ReporteCompraComponent implements OnInit {
  ...
  buscar()
  {
    ...
    this.compraservice.listarCompras(this.fechadesde, this.fechahasta, this.cod_sucursal, this.cod_usuario, this.cod_tipo_documento, this.cod_tipo_deuda, this.cod_proveedor, this.cod_tipo_control).subscribe( (data : any) =>
    {
