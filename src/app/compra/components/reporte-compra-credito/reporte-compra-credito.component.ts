...
@Component({
  selector: 'app-reporte-compra-credito',
  templateUrl: './reporte-compra-credito.component.html',
  styleUrls: ['./reporte-compra-credito.component.css']
})
export class ReporteCompraCreditoComponent implements OnInit {
  ...
  constructor(private toastr: ToastrService, private error:ErrorService, private sucursalesservice:SucursalesService, private formapagoservice : FormaPagoService, private compraservice : CompraService, private usersession: UserSessionService, private bodyStyleService: BodyStyleService) { }
    ...
    if(this.datos.length>0)
    {
      ...
      const pdfDefinition: any = {
        ...
        content: [
          ...
          {
            text: 'Reporte de Compras a Crédito',
            fontSize: 16,  
            alignment: 'center',  
            color: '#047886',
            margin: [0, 0, 0, 10]
  ...
  buscar()
  {
    ...
    this.compraservice.listarComprasCredito(this.fechadesde, this.fechahasta, this.cod_sucursal, this.cod_usuario, this.cod_tipo_documento, this.cod_proveedor).subscribe( (data : any) =>
    {
