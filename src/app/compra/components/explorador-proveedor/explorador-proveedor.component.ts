...
@Component({
  selector: 'app-explorador-proveedor',
  templateUrl: './explorador-proveedor.component.html',
  styleUrls: ['./explorador-proveedor.component.css']
})
export class ExploradorProveedorComponent implements OnInit {
  ...
  handlePageChangeproveedor(event: number): void {
    this.pageproveedor = event;
  }
