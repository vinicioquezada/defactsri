...
@Component({
  selector: 'app-disponibilidad-departamentos',
  templateUrl: './disponibilidad-departamentos.component.html',
  styleUrls: ['./disponibilidad-departamentos.component.css']
})
export class DisponibilidadDepartamentosComponent implements OnInit {
  ...
  revisarDisponibilidadHabitacion()
  {
    $("#mymodaldisponibilidadhabitaciones").modal("show");
  }
  ...
  {
    this.router.navigate(["/menuhotel/exploradorpagos", this.cod_reserva, this.cod_cliente, this.codigo]);
  }
