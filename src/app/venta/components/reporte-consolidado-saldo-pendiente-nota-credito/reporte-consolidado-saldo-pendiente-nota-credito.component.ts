...
@Component({
  selector: 'app-reporte-consolidado-saldo-pendiente-nota-credito',
  templateUrl: './reporte-consolidado-saldo-pendiente-nota-credito.component.html',
  styleUrls: ['./reporte-consolidado-saldo-pendiente-nota-credito.component.css']
})
export class ReporteConsolidadoSaldoPendienteNotaCreditoComponent implements OnInit {
  ...
  totalnotacredito : number = 0;
  totalsaldofavor : number = 0;
    ...
    if(this.datos.length>0)
    {
      ...
      this.datos.forEach(element => {
        let obj = {
          ...
          "NOTAS CREDITOS": element.importetotal,
          "TOTAL SALDO FAVOR": element.total_saldo_favor,
        }
        json.push(obj);
      });
      ...
      let obj = {
        "IDENTIFICACIÓN" : "",
        "CLIENTE" : "",
        "NOTAS CREDITOS": "TOTAL N. CREDITO",
        "TOTAL SALDO FAVOR" : this.totalnotacredito,
      }
      json.push(obj);
      ...
      obj = {
        "IDENTIFICACIÓN" : "",
        "CLIENTE" : "",
        "NOTAS CREDITOS": "TOTAL SALDO FAVOR",
        "TOTAL SALDO FAVOR" : this.totalsaldofavor
      }
      json.push(obj);
  ...
  exportarPdf()
  {
    if(this.datos.length>0)
    {
      let tabla = [];
      let titulo = [];
      titulo[0] = { text: "DOCUMENTO", bold: true };
      titulo[1] = { text: "CLIENTE", bold: true };
      titulo[2] = { text: "NOTAS CREDITOS", bold: true };
      titulo[3] = { text: "TOTAL SALDO FAVOR", bold: true };
      tabla.push(titulo);
      ...
      this.datos.forEach(element => {
        ...
        fila[3] = element.total_saldo_favor;
        tabla.push(fila);
      });
      ...
      fila[0] = "";
      fila[1] = "";
      fila[2] = "TOTAL N. CREDITO";
      fila[3] = this.totalnotacredito;
      tabla.push(fila);

      fila = [];
      fila[0] = "";
      fila[1] = "";
      fila[2] = "TOTAL SALDO FAVOR";
      fila[3] = this.totalsaldofavor;
      tabla.push(fila);
      ...
      const pdfDefinition: any = {
        ...
        content: [
          ...
          {
            text: 'Reporte de Consolidado de Saldo de Nota de Crédito',
            fontSize: 16,  
            alignment: 'center',  
            color: '#047886'
          },
  ...
  buscar()
  {
    ...
    this.notacreditoservice.listarReporteConsolidadoSaldoPendienteNotasCreditos(this.cod_sucursal, this.cod_usuario, this.cod_cliente, this.cod_tipo_documento, this.cod_ruc).subscribe( (data : any) =>
    {
      ...
      if(data.length>0)
      {
        data.forEach(element => {
          element.total_saldo_favor = parseFloat(element.importetotal) - parseFloat(element.total_saldo_ocupado);
          this.totalnotacredito = this.totalnotacredito + parseFloat(element.importetotal);
          this.totalsaldofavor = this.totalsaldofavor + element.total_saldo_favor;
        });
        this.totalnotacredito = redondeardecimales(this.totalnotacredito, 2);
        this.totalsaldofavor = redondeardecimales(this.totalsaldofavor, 2);
      }
