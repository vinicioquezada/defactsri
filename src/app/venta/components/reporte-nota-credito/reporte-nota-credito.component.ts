...
export class ReporteNotaCreditoComponent implements OnInit {
  ...
  exportarPdf()
  {
    if(this.datos.length>0)
    {
      ...
      titulo[6] = { text: "REEMBOLSO", bold: true };
      ...
      const pdfDefinition: any = {
        ...
        content: [
          ...
          {
            text: 'Reporte de Nota de Crédito',
            fontSize: 16,  
            alignment: 'center',  
            color: '#047886'
          },
  ...
  buscar()
  {
    ...
    this.notacreditoservice.listarReporteNotasCreditos(this.fechadesde, this.fechahasta, this.cod_sucursal, this.cod_usuario, this.cod_cliente, this.cod_tipo_documento, this.cod_ruc, this.cod_tipo_fecha).subscribe( (data : any) =>
    {
