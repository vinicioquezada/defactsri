...
@Component({
  selector: 'app-venta-descuento',
  templateUrl: './venta-descuento.component.html',
  styleUrls: ['./venta-descuento.component.css']
})
export class VentaDescuentoComponent implements OnInit {
  ...
  recaudador: string = "";
  estado_recaudado: string = "1"; //Esta Factura es Excluida debe siempre estar en estado recaudado

  descuentodirecto: string = "";

  tipo_venta_anterior: string = "0"

  cod_venta_real: string = "";
  facturaventaexistente: number = 0;
  ...
  ngOnInit(): void {
    ...
    this.defecto_venta = "ELECTRONICA";
    this.facturaventa.tipo_venta = "ELECTRONICA";
  ...
  async verificarCajaAbiertaUsuario()
 {
  ...
  sendChangeRecargo(valor: any) {
    ...
    if(this.tipo_formulario == "finalizarpedidoreservado")
    {
  ...
  */
  ...
  async guardar()
  {
    ...
    //console.log(this.childdetalleventa.datosdetalles);
      ...
      let factura_venta = {
        ...
        'excluir_general' : 1,
        'cod_venta_real' : this.cod_venta_real,
    ...
    let data: any = await lastValueFrom(this.ventaservice.buscarFactura(this.facturaventa.cod_factura_venta));
      ...
      this.disabledbtnmodificar = true;
          ...
          else
          {
            ...
            this.cod_venta_real = data[0].cod_factura_venta;
            ...
            await this.buscarFacturaDescuento();
          }
  ...
  buscarFacturaDescuento(): Promise<any> {
    return new Promise((resolve, reject) => {
      this.ventaservice.buscarFacturaDescuento(this.facturaventa.cod_factura_venta).subscribe( (data: any) => {
          this.facturaventaexistente = data.cantidad_factura_descuento;
          
          if(this.facturaventaexistente > 0)
          {
            this.disabledbtnmodificar = true;
            this.disabledbtnguardar = true;
          }
  ...
  {
    this.childdetalleventa.descuentodirecto = this.descuentodirecto;
    this.childdetalleventa.descontarGeneralDirecto();
  }
