...
@Component({
  selector: 'app-reporte-venta-credito',
  templateUrl: './reporte-venta-credito.component.html',
  styleUrls: ['./reporte-venta-credito.component.css']
})
export class ReporteVentaCreditoComponent implements OnInit {
    ...
    if(this.datos.length>0)
    {
      ...
      const pdfDefinition: any = {
        ...
        content: [
          ...
          {
            text: 'Reporte de Ventas a Crédito',
            fontSize: 16,  
            alignment: 'center',  
            color: '#047886'
          },
  ...
  buscar()
  {
    ...
    this.ventaservice.listarVentasCredito(this.fechadesde, this.fechahasta, this.cod_sucursal, this.cod_usuario, this.cod_tipo_documento, this.cod_cliente, this.cod_ruc).subscribe( (data : any) =>
    {
