...
@Component({
  selector: 'app-reporte-nota-credito-detalles',
  templateUrl: './reporte-nota-credito-detalles.component.html',
  styleUrls: ['./reporte-nota-credito-detalles.component.css']
})
export class ReporteNotaCreditoDetallesComponent implements OnInit {
  ...
  cod_tipo_forma_devolucion : string = "T";
  tipo_forma_devolucion: string = "TODOS";
  datostipoformadevolucion : any[] = [
    {
      "cod_tipo_forma_devolucion" : "T",
      "tipo_forma_devolucion" : "TODOS"
    },
    {
  ...
  changeTipoFormaDevolucion(event: any): void {
      const elemento = event.target.value;
      this.cod_tipo_forma_devolucion = elemento;
      this.tipo_forma_devolucion = this.datostipoformadevolucion.find( (valor : any) => valor.cod_tipo_forma_devolucion == this.cod_tipo_forma_devolucion );
  }
  ...
  exportarExcel()
  {
    if(this.datos.length>0)
    {
      ...
      this.datos.forEach(element => {
        let obj = {
          "Nº NOTA CRÉDITO" : element.numero_nota_credito,
  ...
  exportarPdf()
  {
    if(this.datos.length>0)
    {
      let tabla = [];
      let titulo = [];
      titulo[0] = { text: "Nº NOTA CRÉDITO", bold: true };
      ...
      const pdfDefinition: any = {
        ...
        content: [
          ...
          {
            text: 'Reporte de Notas de Créditos con Detalles',
            fontSize: 16,  
            alignment: 'center',  
            color: '#047886'
          },
          ...
          columns: [
...

                  {
                    stack: [
                      {
                        text: 'TIPO FORMA DEVOLUCIÓN: ' + this.tipo_forma_devolucion,
                        alignment: 'right',
                        fontSize: 11,
                        bold: true,
                        margin: [0, 0, 0, 3]
  ...
  formularioNormal(): void
  {
    ...
    this.cod_tipo_forma_devolucion = "T";
    this.tipo_forma_devolucion = "TODOS";
  }
  ...
  buscar()
  {
    ...
    this.notacreditoservice.listarNotasCreditosDetalles(this.fechadesde, this.fechahasta, this.cod_sucursal, this.cod_usuario, this.cod_cliente, this.cod_tipo_documento, this.cod_ruc, this.cod_tipo_forma_devolucion).subscribe( (data : any) =>
    {
