...
export class VehiculoService {
  ...
  private get api() {
    return this.configService.settings.baseUrl + "/api/ventas/vehiculo/";
  }

  listarVehiculos()
  {
    return this.http.get(this.api + "listarvehiculos");
  }

  buscar(placa: string)
  {
    return this.http.get(this.api + "buscar?placa=" + placa);
  }
