...
@Component({
  selector: 'app-reporte-cuentas-cobrar-consolidado',
  templateUrl: './reporte-cuentas-cobrar-consolidado.component.html',
  styleUrls: ['./reporte-cuentas-cobrar-consolidado.component.css']
})
export class ReporteCuentasCobrarConsolidadoComponent implements OnInit {
    ...
    if(this.datos.length>0)
    {
      ...
      this.datos.forEach(element => {
        let obj = {
          ...
          "TOTAL VENTA" : element.importetotal,
  ...
  exportarPdf()
  {
    if(this.datos.length>0)
    {
      ...
      titulo[2] = { text: "TOTAL VENTA", bold: true };
      ...
      const pdfDefinition: any = {
        ...
        content: [
          ...
          {
            text: 'Reporte de Cuentas por Cobrar de Ventas Consolidadas por Cliente',
            fontSize: 16,  
            alignment: 'center',  
            color: '#047886'
          },
  ...
  buscar()
  {
    ...
    this.abonoventaservice.listarCuentasCobrarConsolidado(this.cod_sucursal, this.cod_usuario, this.cod_tipo_documento, this.cod_cliente, this.cod_tipo_deuda).subscribe( (data : any) =>
    {
