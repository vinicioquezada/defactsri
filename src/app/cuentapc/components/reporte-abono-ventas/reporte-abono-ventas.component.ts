...
@Component({
  selector: 'app-reporte-abono-ventas',
  templateUrl: './reporte-abono-ventas.component.html',
  styleUrls: ['./reporte-abono-ventas.component.css']
})
export class ReporteAbonoVentasComponent implements OnInit {
  ...
  datostipodocumento : any[] = [
    ...
    },
    {
      ...
      "tipo_documento" : "PEDIDO RESERVADO",
    },
    {
      "cod_tipo_documento" : 5,
      "tipo_documento" : "PEDIDO CON SALIDA",
    }
  ];
  ...
  constructor(private toastr: ToastrService, private error:ErrorService, private sucursalesservice:SucursalesService, private formapagoservice : FormaPagoService, private abonoventaservice : AbonoVentaService, private usersession: UserSessionService) { }
    ...
    if(this.datos.length>0)
    {
      ...
      this.datos.forEach(element => {
        let obj = {
          ...
          "TIPO COMPROBANTE" : element.tipo_venta,
          "VALOR" : element.valor
        }
        json.push(obj);
      });
    ...
    if(this.datos.length>0)
    {
      ...
      const pdfDefinition: any = {
        ...
        content: [
          ...
          {
            text: 'Reporte de abonos de ventas',
            fontSize: 16,  
            alignment: 'center',  
            color: '#047886'
          },
  ...
  buscar()
  {
    ...
    this.abonoventaservice.listarAbonosVentas(this.fechadesde, this.fechahasta, this.cod_sucursal, this.cod_usuario, this.cod_tipo_documento, this.id_forma_pago, this.cod_cliente).subscribe( (data : any) =>
    {
