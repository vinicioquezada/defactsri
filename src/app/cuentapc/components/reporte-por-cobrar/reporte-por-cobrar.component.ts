...
@Component({
  selector: 'app-reporte-por-cobrar',
  templateUrl: './reporte-por-cobrar.component.html',
  styleUrls: ['./reporte-por-cobrar.component.css']
})
export class ReportePorCobrarComponent implements OnInit {
    ...
    if(this.datos.length>0)
    {
      ...
      const pdfDefinition: any = {
        ...
        content: [
          ...
          {
            text: 'Reporte de ventas por cobrar',
            fontSize: 16,  
            alignment: 'center',  
            color: '#047886'
          },
  ...
  buscar()
  {
    ...
    this.abonoventaservice.listarCuentasPorCobrar(this.fechadesde, this.fechahasta, this.cod_sucursal, this.cod_usuario, this.cod_tipo_documento, this.id_forma_pago, this.cod_cliente, this.cod_tipo_deuda).subscribe( (data : any) =>
    {
