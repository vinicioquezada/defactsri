...
@Component({
  selector: 'app-reporte-por-pagar',
  templateUrl: './reporte-por-pagar.component.html',
  styleUrls: ['./reporte-por-pagar.component.css']
})
export class ReportePorPagarComponent implements OnInit {
  ...
  exportarExcel()
  {
    if(this.datos.length>0)
    {
      ...
      let obj = {
        ...
        "FECHA" : "",
        "TOTAL" : "TOTAL IMPORTE",
        "DEUDA" : redondeardecimales(this.totalimporte, 2)
      }
      json.push(obj);
      ...
      obj = {
        ...
        "FECHA" : "",
        "TOTAL" : "TOTAL DEUDA",
        "DEUDA" : redondeardecimales(this.totaldeuda, 2)
      }
      json.push(obj);
  ...
  exportarPdf()
  {
    if(this.datos.length>0)
    {
      ...
      titulo[5] = { text: "TOTAL", bold: true };
      titulo[6] = { text: "DEUDA", bold: true };
      tabla.push(titulo);
      ...
      this.datos.forEach(element => {
        ...
        fila[5] = element.importetotal;
        fila[6] = element.deuda_valor;
        tabla.push(fila);
      });
      ...
      const pdfDefinition: any = {
        ...
        content: [
          ...
          {
            text: 'Reporte de compras por pagar',
            fontSize: 16,  
            alignment: 'center',  
            color: '#047886'
          },
  ...
  buscar()
  {
    ...
    this.abonocompraservice.listarCuentasPagarGeneral(this.fechadesde, this.fechahasta, this.cod_sucursal, this.cod_usuario, this.cod_tipo_documento, this.id_forma_pago, this.cod_proveedor, this.cod_tipo_deuda).subscribe( (data : any) =>
    {
